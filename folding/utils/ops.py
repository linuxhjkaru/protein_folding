...
def check_if_directory_exists(output_directory):
    if not os.path.exists(output_directory):
        ...
        print(f"Created directory {output_directory!r}")
    ...
    if input_source == "rcsb":
        ...
        if r.status_code == 200:
            ...
            if is_complete or force:
                ...
                print(f"PDB file {pdb_id} downloaded" + message)
            ...
            print(f"Failed to download PDB file with ID {pdb_id} from {url}")
        ...
        try:
            ...
            print(f"PDB file {pdb_id} downloaded successfully from PDBe.")
